...
function Privacy() {
  return (
    <>
      <h1>Privacy Policy for JG Solution</h1>
      <p>
        At Capital Web, accessible from https://www.jgsolution.tech, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        JG Solution and how we use it. If you have additional questions or
      ...
      <h2>Log Files</h2>
      <p>
        JG Solution follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, JG Solution uses ‘cookies’. These cookies are
        ...
        more general information on cookies, please read the “What Are Cookies”
        article on Cookie Consent website.
      </p>
      ...
      <p>
        ...
        advertising partners of JG Solution. Third-party ad servers or ad
        ...
        Solution, which are sent directly to users’ browser. They automatically
        ...
        visit. Note that JG Solution has no access to or control over these
      ...
      <p>
        JG Solution’s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ...
        participate in, and/or monitor and guide their online activity. JG
        Solution does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Jg Solution. This policy is not applicable to
